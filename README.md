# Приложение "Kometa_Practice" разработано в рамках прохождения производственной практики на АО "Корпорация "КОМЕТА" для обеспечения управления электропитанием в сети подсистемы освещения обстановки Системы мониторинга Мирового океана.
